...
public class ScriptC_multiplication extends ScriptC {
    ...
    private final static int mExportVarIdx_gOut = 3;
    ...
    private final static int mExportVarIdx_count = 6;
    private int mExportVar_count;
    public synchronized void set_count(int v) {
        setVar(mExportVarIdx_count, v);
        mExportVar_count = v;
    }

    public int get_count() {
        return mExportVar_count;
    }
